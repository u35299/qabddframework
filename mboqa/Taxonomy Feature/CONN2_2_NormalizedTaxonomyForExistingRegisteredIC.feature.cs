...
namespace mboqa.TaxonomyFeature
{
    ...
    public partial class TypeAheadCompletionOfSkillsBasedOnNormalizedTaxonomyForExistingRegisteredICFeature
    {
...
#line 1 "CONN2_2_NormalizedTaxonomyForExistingRegisteredIC.feature"
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Type ahead completion of skills based on normalized taxonomy for Existing registe" +
                    "redIC", null, ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        public virtual void TestInitialize()
        {
            if (((testRunner.FeatureContext != null) 
                        && (testRunner.FeatureContext.FeatureInfo.Title != "Type ahead completion of skills based on normalized taxonomy for Existing registe" +
                            "redIC")))
            {
                global::mboqa.TaxonomyFeature.TypeAheadCompletionOfSkillsBasedOnNormalizedTaxonomyForExistingRegisteredICFeature.FeatureSetup(null);
            }
        }
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("CONN2_2_Type ahead completion of skills based on normalized taxonomy for Existing" +
            " registered IC")]
