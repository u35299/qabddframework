...
namespace mboqa.TaxonomyFeature
{
    ...
    public partial class ErrorMessagingWhenUnrecognizedSkillsAreEnteredAsManagerClientFeature
    {
...
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Error messaging when unrecognized skills are entered As manager/client", null, ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        public virtual void TestInitialize()
        {
            if (((testRunner.FeatureContext != null) 
                        && (testRunner.FeatureContext.FeatureInfo.Title != "Error messaging when unrecognized skills are entered As manager/client")))
            {
                global::mboqa.TaxonomyFeature.ErrorMessagingWhenUnrecognizedSkillsAreEnteredAsManagerClientFeature.FeatureSetup(null);
            }
        }
