...
namespace mboqa.TaxonomyFeature
{
    ...
    public partial class ErrorMessagingWhenUnrecognizedSkillsAreEnteredAsManagerOrClientFeature
    {
...
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Error messaging when unrecognized skills are entered As manager or client", null, ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        public virtual void TestInitialize()
        {
            if (((testRunner.FeatureContext != null) 
                        && (testRunner.FeatureContext.FeatureInfo.Title != "Error messaging when unrecognized skills are entered As manager or client")))
            {
                global::mboqa.TaxonomyFeature.ErrorMessagingWhenUnrecognizedSkillsAreEnteredAsManagerOrClientFeature.FeatureSetup(null);
            }
        }
...
#line 13
 testRunner.Then("the error message \"Matching skills not available\" should be displayed", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line 14
 testRunner.And("skill should not be saved", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
